...
st.markdown(f"""
    <div style='margin-top: 1rem; display: flex; align-items: center; justify-content: space-between; padding: 0.1px 0;'>
        <div><img src='data:image/webp;base64,{jarvis_base64}' width='50'/></div>
