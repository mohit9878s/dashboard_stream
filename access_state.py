...
###### ✅ 2. Build access_map from the sheet ######
access_map = {}
...
if not st.session_state.access_granted:
    access_code_input = st.text_input("🔐 Enter your access code to access state-specific dashboard:", type="password",)
    ...
    st.stop()  # 👈 THIS is important to stop dashboard rendering
...
######---------------------- ✅ 2. mannual Access state code ###### --------------
# --- Access Control Setup ---
# access_map = {
#     "bihar123": ["Bihar"],
#     "up123": ["Uttar Pradesh"],
#     "as789": ["Assam"],
#     "multi123": ["Bihar", "Uttar Pradesh"],
#     "admin999": "ALL"  # Special case: access all data
# }
# }

# access_code = st.text_input("🔐 Enter your access code to access state-specific dashboard:", type="password")

# if access_code not in access_map:
#     st.warning("🚫 Invalid or missing access code.")
#     st.stop()

# # Filter by allowed state
# allowed_states = access_map[access_code]

# if allowed_states != "ALL":
#     if isinstance(allowed_states, str):  # In case someone gave a single state as a string
#         allowed_states = [allowed_states]
#     df = df[df["State"].isin(allowed_states)]
######---------------------- ✅ 2. mannual Access state code ###### --------------
