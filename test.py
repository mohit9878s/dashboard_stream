...
access_map = {
    ...
    "up123": "Uttar Pradesh",
    "as789": "Assam",
    "admin999": "ALL"  # Optional: see all data
}

access_code = st.text_input("🔐 Enter your access code to state dashboard:", type="password")
...
allowed_state = access_map[access_code]
